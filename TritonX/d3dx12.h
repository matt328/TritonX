...
struct CD3DX12_BOX : public D3D12_BOX {
   ...
   explicit CD3DX12_BOX(
       LONG Left, LONG Top, LONG Front, LONG Right, LONG Bottom, LONG Back) noexcept {
      left = static_cast<UINT>(Left);
      top = static_cast<UINT>(Top);
...
struct CD3DX12_DEPTH_STENCIL_DESC2 : public D3D12_DEPTH_STENCIL_DESC2 {
   ...
   explicit CD3DX12_DEPTH_STENCIL_DESC2(CD3DX12_DEFAULT) noexcept {
      ...
      DepthFunc = D3D12_COMPARISON_FUNC_LESS;
      StencilEnable = FALSE;
      const D3D12_DEPTH_STENCILOP_DESC1 defaultStencilOp = {D3D12_STENCIL_OP_KEEP,
                                                            D3D12_STENCIL_OP_KEEP,
                                                            D3D12_STENCIL_OP_KEEP,
                                                            D3D12_COMPARISON_FUNC_ALWAYS,
   ...
   explicit CD3DX12_DEPTH_STENCIL_DESC2(BOOL depthEnable,
                                        D3D12_DEPTH_WRITE_MASK depthWriteMask,
                                        D3D12_COMPARISON_FUNC depthFunc,
                                        BOOL stencilEnable,
                                        D3D12_STENCIL_OP frontStencilFailOp,
...
struct CD3DX12_RASTERIZER_DESC2 : public D3D12_RASTERIZER_DESC2 {
   ...
   operator D3D12_RASTERIZER_DESC() const noexcept {
      return static_cast<D3D12_RASTERIZER_DESC>(
          CD3DX12_RASTERIZER_DESC1(static_cast<D3D12_RASTERIZER_DESC1>(*this)));
   }
};
...
struct CD3DX12_TILE_REGION_SIZE : public D3D12_TILE_REGION_SIZE {
   ...
   CD3DX12_TILE_REGION_SIZE(
       UINT numTiles, BOOL useBox, UINT width, UINT16 height, UINT16 depth) noexcept {
      NumTiles = numTiles;
      UseBox = useBox;
      Width = width;
      Height = height;
...
struct CD3DX12_RESOURCE_BARRIER : public D3D12_RESOURCE_BARRIER {
   ...
   static inline CD3DX12_RESOURCE_BARRIER Aliasing(
       _In_opt_ ID3D12Resource* pResourceBefore, _In_opt_ ID3D12Resource* pResourceAfter) noexcept {
      CD3DX12_RESOURCE_BARRIER result = {};
      D3D12_RESOURCE_BARRIER& barrier = result;
...
struct CD3DX12_SUBRESOURCE_FOOTPRINT : public D3D12_SUBRESOURCE_FOOTPRINT {
   ...
   CD3DX12_SUBRESOURCE_FOOTPRINT(
       DXGI_FORMAT format, UINT width, UINT height, UINT depth, UINT rowPitch) noexcept {
      Format = format;
      Width = width;
      Height = height;
      Depth = depth;
...
struct CD3DX12_ROOT_PARAMETER : public D3D12_ROOT_PARAMETER {
   ...
   static inline void InitAsConstants(
      ...
      CD3DX12_ROOT_CONSTANTS::Init(
          rootParam.Constants, num32BitValues, shaderRegister, registerSpace);
   }
...
inline UINT64 UpdateSubresources(_In_ ID3D12GraphicsCommandList* pCmdList,
                                 ...
                                 _In_reads_(NumSubresources)
                                     const D3D12_SUBRESOURCE_DATA* pSrcData) noexcept {
   UINT64 RequiredSize = 0;
   const auto MemToAlloc = static_cast<UINT64>(sizeof(D3D12_PLACED_SUBRESOURCE_FOOTPRINT) +
   ...
   const UINT64 Result = UpdateSubresources(pCmdList,
      ...
      case D3D_ROOT_SIGNATURE_VERSION_1_0:
         switch (pRootSignatureDesc->Version) {
...
#endif
            {
               ...
               if (SUCCEEDED(hr)) {
                  const CD3DX12_ROOT_SIGNATURE_DESC desc_1_0(desc_1_1.NumParameters,
                                                             pParameters_1_0,
...
#if defined(D3D12_SDK_VERSION) && (D3D12_SDK_VERSION >= 610)
// Use CD3DX12_PIPELINE_STATE_STREAM5 for D3D12_RASTERIZER_DESC2 when CheckFeatureSupport returns
// true for Options19::RasterizerDesc2Supported is true Use CD3DX12_PIPELINE_STATE_STREAM4 for
// D3D12_RASTERIZER_DESC1 when CheckFeatureSupport returns true for
// Options16::DynamicDepthBiasSupported is true Use CD3DX12_PIPELINE_STATE_STREAM3 for
// D3D12_DEPTH_STENCIL_DESC2 when CheckFeatureSupport returns true for
// Options14::IndependentFrontAndBackStencilSupported is true Use CD3DX12_PIPELINE_STATE_STREAM2 for
// OS Build 19041+ (where there is a new mesh shader pipeline). Use CD3DX12_PIPELINE_STATE_STREAM1
// for OS Build 16299+ (where there is a new view instancing subobject). Use
...
struct CD3DX12_PIPELINE_STATE_STREAM5 {
   ...
   CD3DX12_PIPELINE_STATE_STREAM5(const D3D12_GRAPHICS_PIPELINE_STATE_DESC& Desc) noexcept :
       ...
       PrimitiveTopologyType(Desc.PrimitiveTopologyType), VS(Desc.VS), GS(Desc.GS),
       ...
       DSVFormat(Desc.DSVFormat), RasterizerState(CD3DX12_RASTERIZER_DESC2(Desc.RasterizerState)),
       RTVFormats(CD3DX12_RT_FORMAT_ARRAY(Desc.RTVFormats, Desc.NumRenderTargets)),
       SampleDesc(Desc.SampleDesc), SampleMask(Desc.SampleMask), CachedPSO(Desc.CachedPSO),
   ...
   D3D12_GRAPHICS_PIPELINE_STATE_DESC GraphicsDescV0() const noexcept {
      ...
      D.DepthStencilState =
          CD3DX12_DEPTH_STENCIL_DESC2(D3D12_DEPTH_STENCIL_DESC2(this->DepthStencilState));
...
#if defined(D3D12_SDK_VERSION) && (D3D12_SDK_VERSION >= 608)
// Use CD3DX12_PIPELINE_STATE_STREAM4 for D3D12_RASTERIZER_DESC1 when CheckFeatureSupport returns
// true for Options16::DynamicDepthBiasSupported is true Use CD3DX12_PIPELINE_STATE_STREAM3 for
// D3D12_DEPTH_STENCIL_DESC2 when CheckFeatureSupport returns true for
// Options14::IndependentFrontAndBackStencilSupported is true Use CD3DX12_PIPELINE_STATE_STREAM2 for
// OS Build 19041+ (where there is a new mesh shader pipeline). Use CD3DX12_PIPELINE_STATE_STREAM1
// for OS Build 16299+ (where there is a new view instancing subobject). Use
...
struct CD3DX12_PIPELINE_STATE_STREAM4 {
   ...
   CD3DX12_PIPELINE_STATE_STREAM4(const D3D12_GRAPHICS_PIPELINE_STATE_DESC& Desc) noexcept :
       ...
       BlendState(CD3DX12_BLEND_DESC(Desc.BlendState)),
       DepthStencilState(CD3DX12_DEPTH_STENCIL_DESC2(Desc.DepthStencilState)),
       DSVFormat(Desc.DSVFormat), RasterizerState(CD3DX12_RASTERIZER_DESC1(Desc.RasterizerState)),
       RTVFormats(CD3DX12_RT_FORMAT_ARRAY(Desc.RTVFormats, Desc.NumRenderTargets)),
       SampleDesc(Desc.SampleDesc), SampleMask(Desc.SampleMask), CachedPSO(Desc.CachedPSO),
       ViewInstancingDesc(CD3DX12_VIEW_INSTANCING_DESC(CD3DX12_DEFAULT())) {
   }
...
#if defined(D3D12_SDK_VERSION) && (D3D12_SDK_VERSION >= 606)
// Use CD3DX12_PIPELINE_STATE_STREAM3 for D3D12_DEPTH_STENCIL_DESC2 when CheckFeatureSupport returns
// true for Options14::IndependentFrontAndBackStencilSupported is true Use
// CD3DX12_PIPELINE_STATE_STREAM2 for OS Build 19041+ (where there is a new mesh shader pipeline).
// Use CD3DX12_PIPELINE_STATE_STREAM1 for OS Build 16299+ (where there is a new view instancing
// subobject). Use CD3DX12_PIPELINE_STATE_STREAM for OS Build 15063+ support.
struct CD3DX12_PIPELINE_STATE_STREAM3 {
   ...
   CD3DX12_PIPELINE_STATE_STREAM3(const D3D12_GRAPHICS_PIPELINE_STATE_DESC& Desc) noexcept :
       ...
       BlendState(CD3DX12_BLEND_DESC(Desc.BlendState)),
       DepthStencilState(CD3DX12_DEPTH_STENCIL_DESC2(Desc.DepthStencilState)),
       DSVFormat(Desc.DSVFormat), RasterizerState(CD3DX12_RASTERIZER_DESC(Desc.RasterizerState)),
       RTVFormats(CD3DX12_RT_FORMAT_ARRAY(Desc.RTVFormats, Desc.NumRenderTargets)),
       SampleDesc(Desc.SampleDesc), SampleMask(Desc.SampleMask), CachedPSO(Desc.CachedPSO),
       ViewInstancingDesc(CD3DX12_VIEW_INSTANCING_DESC(CD3DX12_DEFAULT())) {
   }
...
// CD3DX12_PIPELINE_STATE_STREAM1 Works on OS Build 16299+ (where there is a new view instancing
// subobject). Use CD3DX12_PIPELINE_STATE_STREAM for OS Build 15063+ support.
...
struct CD3DX12_PIPELINE_MESH_STATE_STREAM {
   ...
   CD3DX12_PIPELINE_MESH_STATE_STREAM(const D3DX12_MESH_SHADER_PIPELINE_STATE_DESC& Desc) noexcept :
       Flags(Desc.Flags), NodeMask(Desc.NodeMask), pRootSignature(Desc.pRootSignature), PS(Desc.PS),
       AS(Desc.AS), MS(Desc.MS), BlendState(CD3DX12_BLEND_DESC(Desc.BlendState)),
       DepthStencilState(CD3DX12_DEPTH_STENCIL_DESC1(Desc.DepthStencilState)),
       DSVFormat(Desc.DSVFormat), RasterizerState(CD3DX12_RASTERIZER_DESC(Desc.RasterizerState)),
       RTVFormats(CD3DX12_RT_FORMAT_ARRAY(Desc.RTVFormats, Desc.NumRenderTargets)),
       SampleDesc(Desc.SampleDesc), SampleMask(Desc.SampleMask), CachedPSO(Desc.CachedPSO),
...
// CD3DX12_PIPELINE_STATE_STREAM works on OS Build 15063+ but does not support new subobject(s)
// added in OS Build 16299+. See CD3DX12_PIPELINE_STATE_STREAM1 for instance.
...
struct CD3DX12_PIPELINE_STATE_STREAM3_PARSE_HELPER : public ID3DX12PipelineParserCallbacks {
   ...
   void DSVFormatCb(DXGI_FORMAT DSVFormat) override {
      ...
      if (!SeenDSS && DSVFormat != DXGI_FORMAT_UNKNOWN) {
         // Re-enable depth for the default state.
         static_cast<D3D12_DEPTH_STENCIL_DESC2&>(PipelineStream.DepthStencilState).DepthEnable =
             true;
      }
   }
   void RasterizerStateCb(const D3D12_RASTERIZER_DESC& RasterizerState) override {
      ...
      switch (SubobjectType) {
         ...
         case D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_RASTERIZER1:
            pCallbacks->RasterizerState1Cb(
                *reinterpret_cast<decltype(CD3DX12_PIPELINE_STATE_STREAM4::RasterizerState)*>(
                    pStream));
         ...
         case D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_RASTERIZER2:
            pCallbacks->RasterizerState2Cb(
                *reinterpret_cast<decltype(CD3DX12_PIPELINE_STATE_STREAM5::RasterizerState)*>(
                    pStream));
         ...
         case D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_DEPTH_STENCIL2:
            pCallbacks->DepthStencilState2Cb(
                *reinterpret_cast<decltype(CD3DX12_PIPELINE_STATE_STREAM3::DepthStencilState)*>(
                    pStream));
...
inline bool operator==(
    const D3D12_RENDER_PASS_BEGINNING_ACCESS_PRESERVE_LOCAL_PARAMETERS& a,
...
inline bool operator==(
    const D3D12_RENDER_PASS_ENDING_ACCESS_PRESERVE_LOCAL_PARAMETERS& a,
    const D3D12_RENDER_PASS_ENDING_ACCESS_PRESERVE_LOCAL_PARAMETERS& b) noexcept {
   return ((a.AdditionalWidth == b.AdditionalWidth) && (a.AdditionalHeight == b.AdditionalHeight));
}
#endif
...
class CD3DX12_BARRIER_SUBRESOURCE_RANGE : public D3D12_BARRIER_SUBRESOURCE_RANGE {
 public:
   ...
   CD3DX12_BARRIER_SUBRESOURCE_RANGE(UINT firstMipLevel,
                                     UINT numMips,
       ...
       D3D12_BARRIER_SUBRESOURCE_RANGE{
           firstMipLevel, numMips, firstArraySlice, numArraySlices, firstPlane, numPlanes} {
   }
};
...
class CD3DX12_GLOBAL_BARRIER : public D3D12_GLOBAL_BARRIER {
 public:
   ...
   CD3DX12_GLOBAL_BARRIER(D3D12_BARRIER_SYNC syncBefore,
...
class CD3DX12_BUFFER_BARRIER : public D3D12_BUFFER_BARRIER {
 public:
   ...
   CD3DX12_BUFFER_BARRIER(D3D12_BARRIER_SYNC syncBefore,
                          D3D12_BARRIER_SYNC syncAfter,
                          D3D12_BARRIER_ACCESS accessBefore,
                          D3D12_BARRIER_ACCESS accessAfter,
                          ID3D12Resource* pRes) noexcept :
...
class CD3DX12_TEXTURE_BARRIER : public D3D12_TEXTURE_BARRIER {
 public:
   ...
   CD3DX12_TEXTURE_BARRIER(
       ...
       D3D12_TEXTURE_BARRIER{syncBefore,
                             syncAfter,
                             accessBefore,
                             accessAfter,
                             layoutBefore,
...
class CD3DX12FeatureSupport {
 public: // Function declaration
   ...
   // Retreives the status of the object. If an error occurred in the initialization process, the
   ...
   // FORMAT_SUPPORT
   HRESULT FormatSupport(DXGI_FORMAT Format,
                         D3D12_FORMAT_SUPPORT1& Support1,
                         D3D12_FORMAT_SUPPORT2& Support2) const;

   // MUTLTISAMPLE_QUALITY_LEVELS
   HRESULT MultisampleQualityLevels(DXGI_FORMAT Format,
                                    UINT SampleCount,
   ...
   D3D12_PROTECTED_RESOURCE_SESSION_SUPPORT_FLAGS ProtectedResourceSessionSupport(
       UINT NodeIndex = 0) const;
 ...
 private: // Member data
   ...
   std::vector<D3D12_FEATURE_DATA_PROTECTED_RESOURCE_SESSION_SUPPORT>
...
inline CD3DX12FeatureSupport::CD3DX12FeatureSupport() noexcept :
    m_pDevice(nullptr), m_hStatus(E_INVALIDARG), m_dOptions{}, m_eMaxFeatureLevel{},
    m_dGPUVASupport{}, m_dShaderModel{}, m_dOptions1{}, m_dRootSignature{}, m_dOptions2{},
    m_dShaderCache{}, m_dCommandQueuePriority{}, m_dOptions3{}, m_dExistingHeaps{}, m_dOptions4{},
    m_dCrossNode{}, m_dOptions5{}
#if defined(D3D12_SDK_VERSION) && (D3D12_SDK_VERSION >= 4)
    ,
    m_dDisplayable{}
#endif
...
inline HRESULT CD3DX12FeatureSupport::Init(ID3D12Device* pDevice) {
   ...
   if (FAILED(m_pDevice->CheckFeatureSupport(
           D3D12_FEATURE_D3D12_OPTIONS, &m_dOptions, sizeof(m_dOptions)))) {
      m_dOptions = {};
   }

   if (FAILED(m_pDevice->CheckFeatureSupport(
           D3D12_FEATURE_GPU_VIRTUAL_ADDRESS_SUPPORT, &m_dGPUVASupport, sizeof(m_dGPUVASupport)))) {
      m_dGPUVASupport = {};
   }

   if (FAILED(m_pDevice->CheckFeatureSupport(
           D3D12_FEATURE_D3D12_OPTIONS1, &m_dOptions1, sizeof(m_dOptions1)))) {
      m_dOptions1 = {};
   }

   if (FAILED(m_pDevice->CheckFeatureSupport(
           D3D12_FEATURE_D3D12_OPTIONS2, &m_dOptions2, sizeof(m_dOptions2)))) {
      m_dOptions2 = {};
   }

   if (FAILED(m_pDevice->CheckFeatureSupport(
           D3D12_FEATURE_SHADER_CACHE, &m_dShaderCache, sizeof(m_dShaderCache)))) {
      m_dShaderCache = {};
   }

   if (FAILED(m_pDevice->CheckFeatureSupport(
           D3D12_FEATURE_D3D12_OPTIONS3, &m_dOptions3, sizeof(m_dOptions3)))) {
      m_dOptions3 = {};
   }

   if (FAILED(m_pDevice->CheckFeatureSupport(
           D3D12_FEATURE_EXISTING_HEAPS, &m_dExistingHeaps, sizeof(m_dExistingHeaps)))) {
      m_dExistingHeaps = {};
   }

   if (FAILED(m_pDevice->CheckFeatureSupport(
           D3D12_FEATURE_D3D12_OPTIONS4, &m_dOptions4, sizeof(m_dOptions4)))) {
      m_dOptions4 = {};
   }
   ...
   if (FAILED(m_pDevice->CheckFeatureSupport(
           D3D12_FEATURE_D3D12_OPTIONS5, &m_dOptions5, sizeof(m_dOptions5)))) {
      m_dOptions5 = {};
   }

#if defined(D3D12_SDK_VERSION) && (D3D12_SDK_VERSION >= 4)
   if (FAILED(m_pDevice->CheckFeatureSupport(
           D3D12_FEATURE_DISPLAYABLE, &m_dDisplayable, sizeof(m_dDisplayable)))) {
      m_dDisplayable = {};
   }
#endif

   if (FAILED(m_pDevice->CheckFeatureSupport(
           D3D12_FEATURE_D3D12_OPTIONS6, &m_dOptions6, sizeof(m_dOptions6)))) {
      m_dOptions6 = {};
   }

   if (FAILED(m_pDevice->CheckFeatureSupport(
           D3D12_FEATURE_D3D12_OPTIONS7, &m_dOptions7, sizeof(m_dOptions7)))) {
      m_dOptions7 = {};
   }

#if defined(D3D12_SDK_VERSION) && (D3D12_SDK_VERSION >= 3)
   if (FAILED(m_pDevice->CheckFeatureSupport(
           D3D12_FEATURE_D3D12_OPTIONS8, &m_dOptions8, sizeof(m_dOptions8)))) {
      m_dOptions8 = {};
   }

   if (FAILED(m_pDevice->CheckFeatureSupport(
           D3D12_FEATURE_D3D12_OPTIONS9, &m_dOptions9, sizeof(m_dOptions9)))) {
      m_dOptions9 = {};
   }
#endif
...
#if defined(D3D12_SDK_VERSION) && (D3D12_SDK_VERSION >= 4)
   if (FAILED(m_pDevice->CheckFeatureSupport(
           D3D12_FEATURE_D3D12_OPTIONS10, &m_dOptions10, sizeof(m_dOptions10)))) {
      m_dOptions10 = {};
   }

   if (FAILED(m_pDevice->CheckFeatureSupport(
           D3D12_FEATURE_D3D12_OPTIONS11, &m_dOptions11, sizeof(m_dOptions11)))) {
      m_dOptions11 = {};
   }
#endif
...
#if defined(D3D12_SDK_VERSION) && (D3D12_SDK_VERSION >= 600)
   if (FAILED(m_pDevice->CheckFeatureSupport(
           D3D12_FEATURE_D3D12_OPTIONS12, &m_dOptions12, sizeof(m_dOptions12)))) {
      m_dOptions12 = {};
      m_dOptions12.MSPrimitivesPipelineStatisticIncludesCulledPrimitives =
          D3D12_TRI_STATE::D3D12_TRI_STATE_UNKNOWN;
   }
#endif

#if defined(D3D12_SDK_VERSION) && (D3D12_SDK_VERSION >= 602)
   if (FAILED(m_pDevice->CheckFeatureSupport(
           D3D12_FEATURE_D3D12_OPTIONS13, &m_dOptions13, sizeof(m_dOptions13)))) {
      m_dOptions13 = {};
   }
#endif
...
#if defined(D3D12_SDK_VERSION) && (D3D12_SDK_VERSION >= 606)
   if (FAILED(m_pDevice->CheckFeatureSupport(
           D3D12_FEATURE_D3D12_OPTIONS14, &m_dOptions14, sizeof(m_dOptions14)))) {
      m_dOptions14 = {};
   }

   if (FAILED(m_pDevice->CheckFeatureSupport(
           D3D12_FEATURE_D3D12_OPTIONS15, &m_dOptions15, sizeof(m_dOptions15)))) {
      m_dOptions15 = {};
   }
#endif
...
#if defined(D3D12_SDK_VERSION) && (D3D12_SDK_VERSION >= 608)
   if (FAILED(m_pDevice->CheckFeatureSupport(
           D3D12_FEATURE_D3D12_OPTIONS16, &m_dOptions16, sizeof(m_dOptions16)))) {
      m_dOptions16 = {};
   }
#endif
...
#if defined(D3D12_SDK_VERSION) && (D3D12_SDK_VERSION >= 609)
   if (FAILED(m_pDevice->CheckFeatureSupport(
           D3D12_FEATURE_D3D12_OPTIONS17, &m_dOptions17, sizeof(m_dOptions17)))) {
      m_dOptions17 = {};
   }

   if (FAILED(m_pDevice->CheckFeatureSupport(
           D3D12_FEATURE_D3D12_OPTIONS18, &m_dOptions18, sizeof(m_dOptions18)))) {
...
#if defined(D3D12_SDK_VERSION) && (D3D12_SDK_VERSION >= 610)
   if (FAILED(m_pDevice->CheckFeatureSupport(
           D3D12_FEATURE_D3D12_OPTIONS19, &m_dOptions19, sizeof(m_dOptions19)))) {
      m_dOptions19 = {};
   ...
   for (UINT NodeIndex = 0; NodeIndex < uNodeCount; NodeIndex++) {
      ...
      if (FAILED(m_pDevice->CheckFeatureSupport(D3D12_FEATURE_ARCHITECTURE1,
      ...
      if (FAILED(m_pDevice->CheckFeatureSupport(D3D12_FEATURE_SERIALIZATION,
      ...
      QueryProtectedResourceSessionTypes(NodeIndex,
...
FEATURE_SUPPORT_GET(D3D12_CONSERVATIVE_RASTERIZATION_TIER,
                    m_dOptions,
...
inline HRESULT CD3DX12FeatureSupport::FormatSupport(DXGI_FORMAT Format,
                                                    D3D12_FORMAT_SUPPORT1& Support1,
                                                    D3D12_FORMAT_SUPPORT2& Support2) const {
   ...
   HRESULT result = m_pDevice->CheckFeatureSupport(
       D3D12_FEATURE_FORMAT_SUPPORT, &dFormatSupport, sizeof(D3D12_FEATURE_DATA_FORMAT_SUPPORT));

   Support1 = dFormatSupport.Support1;
   Support2 =
       dFormatSupport
           .Support2; // Two outputs. Probably better just to take in the struct as an argument?

   return result;
}

// 4: Multisample Quality Levels
inline HRESULT CD3DX12FeatureSupport::MultisampleQualityLevels(
    DXGI_FORMAT Format,
    UINT SampleCount,
    D3D12_MULTISAMPLE_QUALITY_LEVEL_FLAGS Flags,
    UINT& NumQualityLevels) const {
...
inline HRESULT CD3DX12FeatureSupport::FormatInfo(DXGI_FORMAT Format, UINT8& PlaneCount) const {
   ...
   HRESULT result = m_pDevice->CheckFeatureSupport(
       D3D12_FEATURE_FORMAT_INFO, &dFormatInfo, sizeof(D3D12_FEATURE_DATA_FORMAT_INFO));
   if (FAILED(result)) {
      PlaneCount = 0;
   } else {
...
inline D3D12_PROTECTED_RESOURCE_SESSION_SUPPORT_FLAGS CD3DX12FeatureSupport::
    ProtectedResourceSessionSupport(UINT NodeIndex) const {
   return m_dProtectedResourceSessionSupport[NodeIndex].Support;
}

// 12: Root Signature
inline D3D_ROOT_SIGNATURE_VERSION CD3DX12FeatureSupport::HighestRootSignatureVersion()
    const noexcept {
...
// 19: Shader Cache
FEATURE_SUPPORT_GET_NAME(D3D12_SHADER_CACHE_SUPPORT_FLAGS,
                         m_dShaderCache,
                         SupportFlags,
                         ShaderCacheSupportFlags);

// 20: Command Queue Priority
inline BOOL CD3DX12FeatureSupport::CommandQueuePrioritySupported(
   ...
   if (FAILED(m_pDevice->CheckFeatureSupport(D3D12_FEATURE_COMMAND_QUEUE_PRIORITY,
...
FEATURE_SUPPORT_GET(D3D12_COMMAND_LIST_SUPPORT_FLAGS,
                    m_dOptions3,
...
FEATURE_SUPPORT_GET(D3D12_SHARED_RESOURCE_COMPATIBILITY_TIER,
                    m_dOptions4,
                    SharedResourceCompatibilityTier);
FEATURE_SUPPORT_GET(BOOL, m_dOptions4, Native16BitShaderOpsSupported);

// 24: Serialization
FEATURE_SUPPORT_GET_NODE_INDEXED(D3D12_HEAP_SERIALIZATION_TIER,
                                 m_dSerialization,
                                 HeapSerializationTier);

// 25: Cross Node
// CrossNodeSharingTier handled in D3D12Options
FEATURE_SUPPORT_GET_NAME(BOOL,
                         m_dCrossNode,
...
inline HRESULT CD3DX12FeatureSupport::QueryMetaCommand(
    D3D12_FEATURE_DATA_QUERY_META_COMMAND& dQueryMetaCommand) const {
   return m_pDevice->CheckFeatureSupport(D3D12_FEATURE_QUERY_META_COMMAND,
                                         &dQueryMetaCommand,
...
#if defined(D3D12_SDK_VERSION) && (D3D12_SDK_VERSION >= 600)
// 41: Options12
FEATURE_SUPPORT_GET(D3D12_TRI_STATE,
                    m_dOptions12,
...
inline HRESULT CD3DX12FeatureSupport::QueryHighestRootSignatureVersion() {
   ...
   constexpr size_t numRootSignatureVersions =
       sizeof(allRootSignatureVersions) / sizeof(D3D_ROOT_SIGNATURE_VERSION);

   for (size_t i = 0; i < numRootSignatureVersions; i++) {
      m_dRootSignature.HighestVersion = allRootSignatureVersions[i];
      result = m_pDevice->CheckFeatureSupport(D3D12_FEATURE_ROOT_SIGNATURE,
                                              &m_dRootSignature,
...
inline HRESULT CD3DX12FeatureSupport::QueryHighestFeatureLevel() {
   ...
   dFeatureLevel.NumFeatureLevels =
       static_cast<UINT>(sizeof(allLevels) / sizeof(D3D_FEATURE_LEVEL));
   dFeatureLevel.pFeatureLevelsRequested = allLevels;

   result = m_pDevice->CheckFeatureSupport(
       D3D12_FEATURE_FEATURE_LEVELS, &dFeatureLevel, sizeof(D3D12_FEATURE_DATA_FEATURE_LEVELS));
   if (SUCCEEDED(result)) {
...
// Helper function to initialize local protected resource session types structs
inline HRESULT CD3DX12FeatureSupport::QueryProtectedResourceSessionTypes(UINT NodeIndex,
                                                                         UINT Count) {
   ...
   HRESULT result =
       m_pDevice->CheckFeatureSupport(D3D12_FEATURE_PROTECTED_RESOURCE_SESSION_TYPES,
